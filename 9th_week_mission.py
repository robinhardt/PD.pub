...
'''
numbers1 = (2, 5, 78, 29)           # ()로 튜플 만들기
numbers2 = 2, 5, 78, 29             # ()없이 튜플 만들기
...
num1 = (29)         # ()로 만든 경우
num2 = (29,)         # (,)로 만든 경우
num3 = 29         # 숫자 1개만 넣어준 경우
num4 = 29,         # 숫자, 로 만들어준 경우
...
print(youtuber["10월 악토"])     # ()안에 값에 접근하는 문장 넣어주기
...
'''
def char_info(name, attack, health, speed):
    print(f"[{name}]")
...
char_info(char1_name, char1_AT, char1_HP, char1_SP)
...
char_info(char2_name, char2_AT, char2_HP, char2_SP)
'''
## case2: 클래스를 사용한 경우
class Character:
...
REINHARDT = Character("라인하르트", 75, 500, 80)
WRECKINGBALL = Character("레킹볼", "발당 5", 600, 120)

REINHARDT.char_info()
WRECKINGBALL.char_info()
