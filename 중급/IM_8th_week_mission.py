...
class GalagaGame():
    ...
    def __init__(self, master):
        ...
        self.canvas.pack()
        # 이미지 생성
        self.alienImage = PhotoImage(r"C:\Users\binip\PycharmProjects\PD.pub\image\alien.png")
        self.shipImage = PhotoImage(r"C:\Users\binip\PycharmProjects\PD.pub\image\starship.png")
        self.shotImage = PhotoImage(r"C:\Users\binip\PycharmProjects\PD.pub\image\fire.png")
        # 게임실행 여부 & sprite 초기화
        self.running = True
        self.initSprites()
        # 이벤트 처리(7가지 이벤트 처리)
