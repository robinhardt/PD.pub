...
'''
word_list = ['study', "octopus", 'overwatch', "pizza", 'mango']
...
print("문제 맞은 개수:", count)
print("틀린 문제 개수:", len(word_list)-count)
'''
# [파일 입출력]
## 파일 입출력 연습문제1: 파일 쓰기(w: 새로쓰기 혹은 덮어쓰기)
'''
file = open('C:/Users/binip/PycharmProjects/PD.pub/test.txt', 'w', encoding='utf-8')
for i in range(1, 10):
    data = f'{i}번쨰 줄입니다.\n'
    file.write(data)
file.close()
...
'''
file = open('C:/Users/binip/PycharmProjects/PD.pub/test.txt', 'a', encoding='utf-8')
...
'''
file = open('C:/Users/binip/PycharmProjects/PD.pub/test.txt', 'r', encoding='utf-8')
while True:
    data = file.readline()
    print(data, end='')
    if data =='':
