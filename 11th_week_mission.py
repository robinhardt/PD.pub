...
shark = Shark('샤크 드레이크', 80, 150)
shark.move()
print(shark.num)

dragon = Dragon('블루 아이즈 화이트 드래곤', 2500, 3000)
dragon.move()
dragon.skill()
dragon.skill()
dragon.skill()
...
## 예외처리 Mission: 영어단어 공부하기 문제를 'while문 + 예외 처리'로 풀어보자 밀랍칠한 약간 산화된 깍인 구리 반블록
